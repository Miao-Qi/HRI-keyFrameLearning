...
As shown in Fig. 1, a controller based on Robot Operating System (ROS) is built on a computer terminal to interface the robot learner with the human teacher. The terminal and the robot communicate with each other via Sphero ROS, an open-source bluetooth driver providing Sphero APIs. 
